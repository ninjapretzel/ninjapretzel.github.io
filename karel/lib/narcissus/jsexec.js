...
function reflectClass(name, proto) {
	...
	// Object.defineProperty(gctor, 'prototype', { value: proto, writable: true, enumerable: true,  configurable: false } );
	// Object.defineProperty(proto, 'constructor', { value: gctor, writable: false, enumerable: true, configurable: false } );
	return proto;
}
